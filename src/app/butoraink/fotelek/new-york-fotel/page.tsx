...
export default function Page() {
  return (
    <ProductPageTemplate
      ...
      gallery={["/images/new-york-a1.webp", "/images/new-york-a2.webp", "/images/new-york-a3.webp", "/images/new-york-a4.webp", "/images/new-york-a5.webp", "/images/new-york-a6.webp", "/images/new-york-a7.webp", "/images/new-york-nc1.webp", "/images/new-york-nc2.webp", "/images/new-york-w5.webp", "/images/new-york-w3.webp", "/images/new-york-w1.webp", "/images/new-york-w4.webp"]}
      pricing={PRODUCT_PRICING["new-york-fotel"]}
