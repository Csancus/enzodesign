...
const CARDS = [
  {
    ...
    images: ["/images/szek-a2.webp", "/images/szek-a5.webp", "/images/szek-a6.webp", "/images/szek-a7.webp", "/images/szek-a8.webp", "/images/szek-a9.webp", "/images/szek-a10.webp", "/images/szek-a11.webp", "/images/szek-a12.webp", "/images/szek-a16.webp", "/images/szek-a17.webp", "/images/szek-a18.webp", "/images/szek-a19.webp", "/images/szek-dsc1.webp", "/images/szek-dsc2.webp", "/images/szek-fb1.webp", "/images/szek-fb2.webp", "/images/szek-fb3.webp", "/images/szek-wales.webp", "/images/szek-msg1.webp", "/images/szek-w2.webp", "/images/szek-w9.webp", "/images/szek-w11.webp", "/images/szek-w12.webp", "/images/szek-w7.webp"],
  ...
  { id: "uzleti", name: "Üzleti garnitúrák", tagline: "Vásárlóid kényelmére", images: ["/images/uzleti-a1.webp", "/images/uzleti-a2.webp", "/images/uzleti-a3.webp", "/images/uzleti-a4.webp", "/images/uzleti-a5.webp", "/images/uzleti-a6.webp", "/images/uzleti-a7.webp", "/images/uzleti-a8.webp", "/images/uzleti-a9.webp", "/images/uzleti-aria.webp", "/images/uzleti-wales.webp", "/images/uzleti-szalloda.webp", "/images/uzleti-w1.webp", "/images/uzleti-w2.webp", "/images/uzleti-w3.webp", "/images/uzleti-w4.webp"], href: "/karpitozott-butor-uzleti-ugyfeleknek" },
];
...
const SELF = "/butoraink/szek-zsamoly-falvedo";
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {resolvedCards.map((c) => (
              <div key={c.id} className="relative group/card">
                ...
                {isAdmin && (
                  c.inherited
                    ? <EditBtn moduleId={`szek-card:${c.id}`} config={{ name: c.name, tagline: c.tagline, href: c.href, imagesEditNote: c.href }} schema={CARD_SCHEMA_NOTE} label="✏" positionClass="absolute top-2 right-2 z-20" />
                    : <EditBtn moduleId={`szek-card:${c.id}`} config={{ name: c.name, tagline: c.tagline, href: c.href, images: c.images.map((src) => ({ src })) }} schema={CARD_SCHEMA} label="✏" positionClass="absolute top-2 right-2 z-20" />
                )}
              </div>
            ))}
          </div>
