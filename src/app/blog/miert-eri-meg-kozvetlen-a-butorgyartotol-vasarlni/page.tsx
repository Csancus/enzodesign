    ...
    <>
      ...
      <nav aria-label="Tartalomjegyzék" className="bg-[#f5f0e8] border-b border-[#e8ddd0]">
        <div className="max-w-3xl mx-auto px-4 py-5">
          ...
          <li className="flex items-start gap-2 text-sm text-[#1c1c1c]"><span className="text-[#b8924a] font-bold min-w-[1.5rem]">1.</span><span>5 ok, amiért érdemes gyártótól vásárolni</span></li>
          <li className="flex items-start gap-2 text-sm text-[#1c1c1c]"><span className="text-[#b8924a] font-bold min-w-[1.5rem]">2.</span><span>Összehasonlítás: gyártótól vs. bútorboltból</span></li>
          <li className="flex items-start gap-2 text-sm text-[#1c1c1c]"><span className="text-[#b8924a] font-bold min-w-[1.5rem]">3.</span><span>GYIK – Gyártói vásárlás</span></li>
          </ol>
        </div>
      </nav>
