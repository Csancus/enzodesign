...
const NAV = [
  ...
  },
  {
    heading: "Városok",
    links: [
      { label: "Bútorbolt Zalaegerszeg", href: "/butorbolt-zalaegerszeg" },
      { label: "Bútorbolt Kaposvár", href: "/butorbolt-kaposvar" },
      { label: "Bútorbolt Keszthely", href: "/butorbolt-keszthely" },
      { label: "Bútorbolt Siófok", href: "/butorbolt-siofok" },
      { label: "Bútorbolt Tapolca", href: "/butorbolt-tapolca" },
      { label: "Bútorbolt Marcali", href: "/butorbolt-marcali" },
      { label: "Bútorbolt Körmend", href: "/butorbolt-kormend" },
      { label: "Bútorbolt Barcs", href: "/butorbolt-barcs" },
      { label: "Bútorbolt Szigetvár", href: "/butorbolt-szigetvar" },
      { label: "Bútorbolt Nagykanizsa", href: "/butorbolt-nagykanizsa" },
      { label: "Bútorbolt Budapest", href: "/butorbolt-budapest" },
    ],
  },
];
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-9 gap-8 mb-10">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1">
            ...
            <div className="mt-4 flex gap-4">
              <TrackedLink href="https://www.facebook.com/enzodesignbutor/" event="social_klikk" label="Facebook" target="_blank" rel="noopener noreferrer me" aria-label="Facebook" className="text-gray-400 hover:text-[#b8924a] transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
              </TrackedLink>
              <TrackedLink href="https://www.instagram.com/enzodesignbutor/" event="social_klikk" label="Instagram" target="_blank" rel="noopener noreferrer me" aria-label="Instagram" className="text-gray-400 hover:text-[#b8924a] transition-colors">
              ...
              <TrackedLink href="https://www.tiktok.com/@enzodesign2015" event="social_klikk" label="TikTok" target="_blank" rel="noopener noreferrer me" aria-label="TikTok" className="text-gray-400 hover:text-[#b8924a] transition-colors">
          ...
          <div className="col-span-1">
            ...
            <address className="not-italic text-xs text-gray-400 space-y-1.5">
              ...
              <p><TrackedLink href="tel:+36303778983" event="telefon_klikk" label="Lábléc" className="hover:text-[#b8924a] transition-colors">+36 30 377 8983</TrackedLink></p>
              <p><TrackedLink href="mailto:info@enzodesign.hu" event="email_klikk" label="Lábléc" className="hover:text-[#b8924a] transition-colors">info@enzodesign.hu</TrackedLink></p>
            </address>
            ...
            {/* Google rating badge */}
            <TrackedLink
              href="/vasarloi-visszajelzesek"
              event="cta_gomb"
              label="Google értékelés badge (lábléc)"
              className="mt-5 inline-flex items-center gap-2 bg-white/5 hover:bg-white/10 border border-white/10 px-3 py-2 transition-colors"
            >
              ...
              <div>
                ...
                <span className="text-gray-400 text-[10px]">12 Google értékelés</span>
              </div>
            </TrackedLink>
          </div>
        </div>
